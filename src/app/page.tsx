    ...
    <div className="min-h-screen bg-[#070D1A] px-6 py-8 max-w-[1440px] mx-auto">
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xs font-semibold text-[#475569] tracking-widest uppercase"
              style={{ fontFamily: 'Space Mono, monospace' }}>
            Platform Modules
          </h2>
          <span
      ...
      {/* ── ROI Banner ── */}
      <div className="relative mb-8 overflow-hidden rounded-xl border border-[#00D4AA]/20 bg-[#0A1225]">
        <div className="absolute inset-0 bg-gradient-to-r from-[#00D4AA]/5 via-transparent to-[#0D6EFD]/5" />
        <div className="relative flex items-center justify-between px-6 py-4 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#00D4AA]/10 border border-[#00D4AA]/20">
              <span className="text-sm font-bold text-[#00D4AA]" style={{ fontFamily: 'Space Mono, monospace' }}>RZ</span>
            </div>
            <div>
              <p className="text-xs text-[#475569] mb-0.5" style={{ fontFamily: 'Space Mono, monospace' }}>
                THIS MONTH · AI AUTOMATION IMPACT
              </p>
              <p className="text-sm text-[#CBD5E1]">
                RZ automated{' '}
                <span className="font-bold text-[#00D4AA]">4,821 actions</span>
                {' · '}saved{' '}
          ...
          <div className="flex gap-6">
            <div className="text-center">
              <div className="text-lg font-bold text-[#00D4AA]" style={{ fontFamily: 'Space Mono, monospace' }}>4,821</div>
              <div className="text-[10px] text-[#475569]" style={{ fontFamily: 'Space Mono, monospace' }}>ACTIONS</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[#F1F5F9]" style={{ fontFamily: 'Space Mono, monospace' }}>487h</div>
              <div className="text-[10px] text-[#475569]" style={{ fontFamily: 'Space Mono, monospace' }}>SAVED</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[#00D4AA]" style={{ fontFamily: 'Space Mono, monospace' }}>$127K</div>
              <div className="text-[10px] text-[#475569]" style={{ fontFamily: 'Space Mono, monospace' }}>AVOIDED</div>
            </div>
          </div>
        </div>
      </div>

      {/* ── Bottom Grid: Activity + AI Insights ── */}
      <div className="grid grid-cols-5 gap-6">
        ...
        <section className="col-span-3">
          ...
          <div className="bg-[#0A1225] border border-[#0F2040] rounded-xl overflow-hidden">
            {ACTIVITY.map((item, idx) => (
              <div
                key={item.id}
                className={`flex items-start gap-3 px-4 py-3 ${idx < ACTIVITY.length - 1 ? 'border-b border-[#0F2040]' : ''} hover:bg-[#060D1A] transition-colors duration-100`}
              >
                {/* Module dot */}
                <div className="flex-shrink-0 mt-1.5">
                  <div
                    className="w-1.5 h-1.5 rounded-full"
                    style={{ backgroundColor: item.moduleColor, boxShadow: `0 0 4px ${item.moduleColor}80` }}
                  />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className="text-[10px] text-[#475569]" style={{ fontFamily: 'Space Mono, monospace' }}>
                      {item.time}
                    </span>
                  </div>
                </div>
